...
import Counter, { CounterNameType, CounterType } from "./components/counter/Counter";
  ...
  return (
    <section className={styles.tickets} id="Tickets">
      <div className={`${styles.tickets__container} container`}>
        <H2 type={TitleType.UNDERLINED} colorType={TitleColorType.GOLD} className={styles.tickets__title}>
          Buy tickets
        </H2>
            ...
            <ul className={styles["ticket-type__list"]}>
              <li>
                <label htmlFor="Permanent">
                  <input type="radio" {...register("exhibition")} id="Permanent" value="Permanent exhibition" />
                  Permanent exhibition
                </label>
              </li>
              <li>
                <label htmlFor="Temporary">
                  <input type="radio" {...register("exhibition")} id="Temporary" value="Temporary exhibition" />
                  Temporary exhibition
                </label>
              </li>
              <li>
                <label htmlFor="Combined">
                  <input type="radio" {...register("exhibition")} id="Combined" value="Combined Admission" />
                  Combined Admission
                </label>
              </li>
            </ul>
            ...
            <ul className={styles.counters}>
              <li>
                ...
                <FormProvider {...methods}>
                  <Counter counterType={CounterType.LIGHT} counterName={CounterNameType.BASIC} />
                </FormProvider>
              </li>
              <li>
                <p>Senior 65+</p>
                <FormProvider {...methods}>
                  <Counter counterType={CounterType.LIGHT} counterName={CounterNameType.SENIOR} />
                </FormProvider>
              </li>
            </ul>

            <H4>Total {basic * prices[exhibition].basic + senior * prices[exhibition].senior} €</H4>
