  ...
  return (
    <Link href={`/map/${tour.i}`} scroll={false}>
      <figure className={styles.tour__content}>
        <Image src={tour.preview} width={440} height={285} alt={tour.name} className={styles.tour__preview} />
        ...
        <figcaption className={styles.tour__caption}>
          ...
          <span className={styles.tour__caption_addition}>Google Street Panorama View</span>
        </figcaption>
      </figure>
    </Link>
  );
